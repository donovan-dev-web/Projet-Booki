...
puis les tablettes et enfin les téléphones. L’utilisation des **Media Queries nous permettra de réaliser l’intégration pour les différents supports.**
#### Bibliothèque d’icônes :
Les icônes proviennent de la bibliothèque Font Awesome.
#### Couleurs :
Les **couleurs** de la charte sont le **bleu <span style="display:inline-block; width:15px; height:15px; background:#0065FC"></span>
(#0065FC)**, **le bleu clair <span style="display:inline-block; width:15px; height:15px; background:#DEEBFF"></span> (#DEEBFF)** et le **gris pour le
fond <span style="display:inline-block; width:15px; height:15px; background:#F2F2F2"></span> (#F2F2F2).**
#### Police :
...
#### Balises sémantiques :
l est important d’**utiliser des balises sémantiques**, au minimum “header”, “nav”,
...
## Suivi d’avancement / Étapes du projet : 
